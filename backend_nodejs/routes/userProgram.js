...
const { getUserProgram, addUserProgram, updateName, updateDescription, updateDuration, updateTime, deleteUserProgram, getUserProgramById } = require('../controllers/userProgram');
